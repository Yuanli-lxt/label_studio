...
DATASET_REGISTRY: dict[str, DatasetRegistryEntry] = {
    ...
    "cod10k": DatasetRegistryEntry(
        ...
        expected_annotation_files=(),
        license_note="Confirm COD10K license and source terms before local use.",
        official_page_note="Manual placement is required; unstable Google Drive/Baidu links are not scripted.",
        supports_scripted_download=False,
        supports_manual_import=True,
        supports_preflight=True,
        recommended_first_sample_size=300,
    ...
    "camo": DatasetRegistryEntry(
        ...
        expected_annotation_files=(),
        license_note="Confirm CAMO license and source terms before local use.",
        official_page_note="Manual placement is required; unstable Google Drive/Baidu links are not scripted.",
        supports_scripted_download=False,
        supports_manual_import=True,
        supports_preflight=True,
